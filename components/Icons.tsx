...
export const PrintIcon: React.FC<{className?: string}> = ({className = "h-5 w-5"}) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 20 20" fill="currentColor">
        <path fillRule="evenodd" d="M5 4v3h10V4a2 2 0 00-2-2H7a2 2 0 00-2 2zm10 5H5a1 1 0 00-1 1v6a1 1 0 001 1h1v-2a1 1 0 112 0v2h4v-2a1 1 0 112 0v2h1a1 1 0 001-1v-6a1 1 0 00-1-1zM9 15a1 1 0 100-2 1 1 0 000 2z" clipRule="evenodd" />
    </svg>
);
